...
Installer and Skill versions differ: `skills@1.5.23` pins the installer, while `tiangong-lca/agent-skills` can change upstream. Keep `skills-lock.json`, current files, and verified results. Before updating, check for local modifications and preserve needed changes in version control or a backup.
