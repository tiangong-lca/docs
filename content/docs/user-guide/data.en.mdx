...
description: "Introduces the TianGong LCA data module: its role, core concepts such as model, process, flow, unit group and source, permission differences, and typical usage before creating or reviewing data."
---
